    ...
    public function update_account($id) {
        ...
        try {
            ...
            if (!filter_has_var(INPUT_POST, 'balance') ||
                ...
                throw new DatabaseException("Recieved incomplete or missing data from Database");
            }
            ...
            if (empty($balance) || empty($email) || empty($username) || empty($password)) {
...
//        //query string for update 
//        $sql = "UPDATE " . $this->tblAccount .
//                " SET email='$email', password='$hashed_password', username='$username', balance='$balance'"
//                . "WHERE account_id='$id'";
//
//        //execute the query
//        return $this->dbConnection->query($sql);
