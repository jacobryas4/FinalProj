...
class ComposerStaticInit2aa62ca7900cf9d7c7258cee3d36ecdf
{
    public static $classMap = array (
        ...
        'Login' => __DIR__ . '/../..' . '/views/user/index/login.class.php',
        ...
        'UserLoginVerifyView' => __DIR__ . '/../..' . '/views/user/index/user_login_verify.class.php',
        'UserLoginView' => __DIR__ . '/../..' . '/views/user/index/user_index.class.php',
        'UserLogoutView' => __DIR__ . '/../..' . '/views/user/logout/user_logout.class.php',
        ...
        'UserReset' => __DIR__ . '/../..' . '/views/user/reset/user_reset.class.php',
        'UserResetConfirm' => __DIR__ . '/../..' . '/views/user/reset/user_reset_confirm.class.php',
        'Verify' => __DIR__ . '/../..' . '/views/user/index/verify.class.php',
